 ...
 *
 * `typedef enum {`<br>
 * `    SChartTickLabelClippingModeTicksAndLabelsPersist,`<br>
 * `    SChartTickLabelClippingModeTicksPersist,`<br>
 * `    SChartTickLabelClippingModeNeitherPersist`<br>
 * `} SChartTickLabelClippingMode;`
 *
 *
 * SChartTickLabelClippingModeTicksAndLabelsPersist - Keep both the label and tick visible for as long as possible, allowing the label to overlap with adjacent axes.<br>
 * SChartTickLabelClippingModeTicksPersist          - Keep the tick mark visible for as long as possible and clip the label as soon as it reaches the edge of its view.<br>
 * SChartTickLabelClippingModeNeitherPersist        - Keep the tick mark visible as long as the tick label is visible - as soon as the tick label reaches its bounds, and is clipped, clip the tick mark too.<br>
 * 
 */
...
- (SChartRange *)appropriateRangeWithFloatMin:(double)min andFloatMax:(double)max;
...
- (int) indexOfFirstLabel:(int)ticksPerLabel;
