...
/** If set to YES, legend labels will autosize to fit their text.
 
 Note that the legend frame will still be overridden is a frame is set manually,
 but this setting will override any fixedWidthRatio that has been set. */
